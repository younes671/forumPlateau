                ...
                if($category)
                {
                    ...
                    if($category)
                    {
                        ...
                        <?php if($topic->getClosed())
                            { ?>
                                    <p class="lien"><a class="lien-gestion3" href="index.php?ctrl=security&action=unlockTopic&id=<?= $topic->getId() ?>">Déverrouiller</i></a></p>
                        <?php } else
                            { ?>
                                    <p class="lien"><a class="lien-gestion3" href="index.php?ctrl=security&action=lockTopic&id=<?= $topic->getId() ?>">Verrouiller</i></a></p>
                        <?php } ?>  
                        </div> 
                        </div>     
                        <?php  }
